                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('Book',style: TextStyle(color: Colors.pinkAccent[100],fontSize: 20,letterSpacing: 1),),
                                Text(' Stories',style: TextStyle(fontSize: 20,letterSpacing: 1)),
                              ],
                            ),
                            Icon(Icons.arrow_forward,color: Colors.pinkAccent[100],),
                          ],
                        ),
                      ),
                    ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('Baba',style: TextStyle(color: Colors.yellow[800],fontSize: 20,letterSpacing: 1),),
                              ],
                            ),
                            Icon(Icons.arrow_forward,color: Colors.pinkAccent[100],),
                          ],
                          ...
                          itemBuilder: (BuildContext context,int index){
                            return Container(
                              ...
                              Navigator.push(context, PageTransition(type: PageTransitionType.bottomToTop, child: Blog()));
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text('05:45 Am, 17 Oct',style: TextStyle(color: Colors.black.withOpacity(0.5)),),
                                    ),
                                  ],
                                ),
                              ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Flexible(child: Text('Go to Top  ',style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),)),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: _width*0.65 *0.05,),
              Text(lebel,style: TextStyle(fontSize: 16,color: Colors.black),),
            ],
          ),
        ),
      ),
