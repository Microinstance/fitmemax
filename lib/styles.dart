...
class TextStyles {
  ...
  static const ParaBlack = TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: Colors.black);
  static const ParaBoldBlack = TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.black);
  static const ParaOrange = TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: Colors.orange);
  ...
  static const HeadingOrange = TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: Colors.orange,);
  static const HeadingWhite = TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: Colors.white,);
  ...
  static const TitleBlack = TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.black,);
  static const TitlePrimery = TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: ColorPalette.PrimaryColor);
